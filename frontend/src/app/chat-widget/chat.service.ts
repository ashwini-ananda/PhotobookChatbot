...
export class ChatService {
    ...
    reply(message:string) {
        ...
        //   },
        // }
      return this.http.post("http://127.0.0.1:8000/api/messages",{"sender": 2, "roundId": 1, "receiver": 1, "message": message});
    ...
    getImages() {
       return this.http.get("http://127.0.0.1:8000/api/game/new/1")
